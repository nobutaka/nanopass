(add-tests-with-string-output "gc"
  ...
  [(letrec ((fib (lambda n (if (= (car n) 0) (car n) (if (= (car n) 1) (car n) (+ (fib (- (car n) 1)) (fib (- (car n) 2)))))))) (fib 35)) => "9227465\n"]
  [(letrec ((accum (lambda (n pair) (if (= n 1000000) pair (accum (+ n 1) (cons (+ n 1) '())))))) (accum 0 (cons 0 '()))) => "(1000000)\n"]
